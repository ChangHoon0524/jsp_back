...
public class MyBatisConfig {
	...
	// 팩토리는 딱 한 번만 프로그램이 시작할 때 만들면 된다
	// static 초기화 블록으로 만든다
	static {
		try {
			// 설정 파일의 경로를 저장한다
	...
	// sqlSessionFactory의 접근제한자가 private이므로 getter를 만든다
	// static 변수이므로 getter에도 static이 붙는것을 확인할 수 있다
